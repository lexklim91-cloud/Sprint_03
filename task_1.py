...
class OnlineSalesRegisterCollector:
    ...
    def twenty_percent_tax_calculation(self):
        ...
        if self.__number_items > 10:
            discounted_sum = full_sum * 0.9
            vat_amount = discounted_sum * 0.2
        else:  
            vat_amount = full_sum * 0.2        
        return vat_amount
    ...
    def ten_percent_tax_calculation(self):
        ...
        if self.__number_items > 10: 
            discounted_sum = full_sum * 0.9           
            vat_amount = discounted_sum * 0.1
        else:
            vat_amount = full_sum * 0.1   
        return vat_amount

    def total_tax(self):
        total_vat = self.twenty_percent_tax_calculation() + self.ten_percent_tax_calculation()
        return total_vat
